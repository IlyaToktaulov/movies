...
moviesListNode.addEventListener('click', (event)=>{
    if (event.target.classList.contains('circle-btn')) muvieViewed(event.target.closest('.movie-wrapper'));
...
//# sourceMappingURL=movies.44983732.js.map
